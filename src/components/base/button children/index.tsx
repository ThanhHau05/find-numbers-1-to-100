...
export const ButtonChildren = ({
  ...
  return (
    <button
      ...
      type="button"
      className={clsx(
        'group flex flex-col items-center rounded-lg border-slate-400 bg-slate-100 p-2 uppercase shadow-lg transition-all hover:border-gray-600  hover:shadow-xl',
